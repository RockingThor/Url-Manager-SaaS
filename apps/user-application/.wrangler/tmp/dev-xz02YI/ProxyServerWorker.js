...
// ../../node_modules/.pnpm/wrangler@4.33.1_@cloudflare+workers-types@4.20250831.0/node_modules/wrangler/wrangler-dist/ProxyServerWorker.js
import { EmailMessage } from "cloudflare:email";
Symbol.dispose || (Symbol.dispose = Symbol.for("dispose"));
Symbol.asyncDispose || (Symbol.asyncDispose = Symbol.for("asyncDispose"));
var N = true ? "cloudflare:workers" : null;
var v;
N && (v = await import(N));
    ...
    if (e instanceof Array) {
      if (e.length == 1 && e[0] instanceof Array) {
        ...
        case "pipeline":
          ...
          let n = e[0] == "pipeline", i = /* @__PURE__ */ __name((l) => {
            if (n) {
              let u = new c(l, []);
...
// ../../node_modules/.pnpm/wrangler@4.33.1_@cloudflare+workers-types@4.20250831.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// .wrangler/tmp/bundle-D0EMcA/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default
];
var middleware_insertion_facade_default = ProxyServerWorker_default;

// ../../node_modules/.pnpm/wrangler@4.33.1_@cloudflare+workers-types@4.20250831.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-D0EMcA/middleware-loader.entry.ts
